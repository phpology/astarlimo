...
<div class="homecontentholderline1">
<div class="homecontentholderline1top">
<div id="flowtabs" class="navi">
<ul>
	<li><a id="t1" href="#Rickshaw">Rickshaw</a></li>
	<li><a id="t2" href="#Luxury_Cars">Luxury Cars</a></li>
	<li><a id="t3" href="#Horse_Drawn_Carriage">Horse Drawn Carriage</a></li>
</ul>
</div>
</div>
<div class="homecontentholderline1bottom">
<div id="flowpanes">
  ...
  <div class="items">
    ...
    <div>
    <div class="slide1">
    <a href="rickshaw_a_star_limousine.php"></a>
    </div>
    <br clear="all" />
    </div>
    <!--end-->
    ...
    <div>
<div class="slide2">
<a href="luxury_cars_a_star_limousine.php"></a>
</div>
      <br clear="all" />
    </div>
    <!--end-->
    ...
    <div>
<div class="slide3">
<a href="horse_drawn_carriage_a_star_limousine.php"></a>
</div>
      <br clear="all" />
    </div>
    <!--end-->
...
<div class="homecontentholderline2">
<div class="homecontentholderline2left">
<h1>We are a family run business and understand the complications in arranging weddings &amp; special events. </h1>
<p>Make your special day even special, Why not hire a Classic or Vintage Rolls Royce to add to you day or if you are looking for a more prestige car why not hire a New Phantom or Bentley. Or like Cinderella make it even special and Hire a Horse and Carriage.</p>
</div>
<div class="homecontentholderline2right">
<div class="getintouch"><a href="#">Get In Touch</a></div>
</div>
</div>
</div>
<!-- InstanceEndEditable -->

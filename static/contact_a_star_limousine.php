...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/main2.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<!-- InstanceBeginEditable name="doctitle" -->
<title>Contact A Star Limousine | Tuk Tuk | Luxury Cars | Horse Drawn Carriage | Rickshaw - Est.1990</title>
<meta name="title" content="Contact A Star Limousine | Tuk Tuk | Luxury Cars | Horse Drawn Carriage | Rickshaw - Est.1990">
...
<meta itemprop="name" content="Contact A Star Limousine | Tuk Tuk | Luxury Cars | Horse Drawn Carriage | Rickshaw - Est.1990">
...
<div class="contactholderleft">
<div class="contactholderleftline1"><h1>GIVE US A CALL TO GET IN TOUCH OR FILL IN FORM...</h1></div>
<div class="contactholderleftline2">
...
<h2>07956 39 28 01 / 07890 39 68 75</h2>
<h3><a href="mailto:INFO@ASTARLIMOUSINE.CO.UK">INFO@ASTARLIMOUSINE.CO.UK</a></h3>
<h4>68 Weston Drive, Stanmore, Middlesex, HA7 2ES.</h4>
</div>
<div class="contactholderleftline3">
<div class="vehiclesbutt"><a href="our_vehicles_a_star_limousine.php">View Our Vehicles</a></div>
</div>
</div>
<div class="contactholderright">
...
<div class="contactformline1"><input name="name" type="text" id="name"></div>
<div class="contactformline2"><input name="number" type="text" id="number"></div>
<div class="contactformline3"><input name="email" type="text" id="email"></div>
<div class="contactformline4">
<select name="vehicle">
...
<div class="contactformline5"><input name="date" type="text" id="date"></div>
<div class="contactformline6"><textarea name="additional" id="additional"></textarea></div>
<div class="contactformline7">
<div class="contactformline7left"></div>
<div class="contactformline7right">
  <button type="submit"><img src="css/images/sce/contactbutt.png" width="117" height="40" /></button></div>
</div>
</form>
</div>
</div>
